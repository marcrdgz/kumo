...
pub const THEMES: [Theme; 5] = [
    Theme {
        ...
        mauve: RColor::Rgb(0xcb, 0xa6, 0xf7),
    ...
    Theme {
        ...
        mauve: RColor::Rgb(0xc7, 0x7d, 0xff),
    ...
    Theme {
        ...
        mauve: RColor::Rgb(0xa7, 0x8b, 0xfa),
    ...
    Theme {
        ...
        mauve: RColor::Rgb(0x9d, 0x4e, 0xdd),
    ...
    Theme {
        ...
        mauve: RColor::Rgb(0xa5, 0x7f, 0xb8),
